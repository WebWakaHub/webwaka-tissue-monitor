/**
 * MonitorTissue — Type Definitions
...
// Tissue Identity
export const TISSUE_ID = 'TIS-MONITOR-v0.1.0' as const;
export const TISSUE_HASH = '956ddcdb' as const;
export const CLASSIFICATION = 'Scale & Deployment' as const;
export const COMPOSED_CELLS = ['CEL-HEALTHCHECK', 'CEL-METRICS', 'CEL-ALERTING'] as const;
